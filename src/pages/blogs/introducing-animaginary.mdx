...
import deskImg from '@/images/blogsImages/office.png'
...
export const meta = {
  ...
  description:
    'When you’re building a website for a company as ambitious as NasDesign you need to make an impression. I wanted people to visit our website and see animations that looked more realistic than reality itself.',
  images: [deskImg, deskImg, deskImg, deskImg, deskImg],
}

export default (props) => <ArticleLayout meta={meta} {...props} />

When you’re building a website for a company as ambitious as NasDesign you need
to make an impression. I wanted people to visit our website and see animations that
...
```js
import { animate } from '@nasdesign/animaginary'
