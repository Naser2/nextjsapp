      ...
      <Container>
        <div className="flex flex-col items-start">
          ...
          <div className="mt-4 flex items-center gap-4">
            ...
            <Link
              href={`/${episode.id}`}
              className="flex items-center text-sm font-bold leading-6 text-red-400 hover:text-red-700 active:text-red-900"
...
//   export default function LandingPageMusic({ episodes }) {
//     return (
//       <>
//         <Head>
//           <title>
...
export default function LandingPageMusic({ Component, pageProps }) {
  return (
    <AudioProvider>
      <AudioPlayer {...pageProps} />
    </AudioProvider>
  )
}
