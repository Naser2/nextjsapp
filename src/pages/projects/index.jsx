    ...
    <>
      ...
      <section id="modern-features">
        <div id="projects-broadcasct-baby" className="projects-broadcast">
          <h1 class="col-start-1 row-start-2 max-w-[36rem] px-2 text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-7xl sm:text-6xl md:mt-4 xl:max-w-[43.5rem]">
            BroadcastBaby
          </h1>
        ...
        <div class="relative mt-10 pt-10 xl:mt-2 xl:pt-0">
          <div class="absolute inset-x-0 top-0 top-0 hidden h-[37.5rem] bg-gradient-to-b from-[#0c1120] dark:block xl:top-8"></div>
          <div class="GridLockup_beams-0___8Vns absolute inset-x-0 top-0 top-0 bg-top bg-no-repeat xl:top-8"></div>
          <div class="bg-grid-slate-900/[0.04] dark:bg-grid-slate-100/[0.03] absolute inset-x-0 top-0 top-0 h-[37.5rem] bg-top [mask-image:linear-gradient(0deg,transparent,black)] dark:border-t dark:border-slate-100/5 dark:bg-[center_top_-1px] xl:top-8"></div>
          <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:grid lg:grid-cols-12 lg:gap-8">
            <div class="flex flex-col lg:col-span-5 xl:col-span-6">
              <div class="xl:mt-18 flex text-4xl font-black lg:mt-10">
                <div class="grid w-full flex-none grid-cols-3 grid-rows-2 gap-8">
                  <div
                  //   style="transform:none"
                  >
                    <div class="pt-full relative overflow-hidden rounded-lg bg-white shadow-lg transition-[filter] duration-500">
                      <img
                  ...
                  <div
                    class="relative col-start-2 col-end-4 row-start-1 row-end-2 overflow-hidden rounded-lg bg-white shadow-lg transition-[filter] duration-500"
            ...
            {/* <div class="-mx-4 mt-4 sm:mx-0 lg:col-span-7 lg:mt-0 xl:col-span-6">
              <div class="relative flex h-[31.625rem] max-h-[60vh] overflow-hidden bg-slate-800 shadow-xl dark:bg-slate-900/70 dark:ring-1 dark:ring-inset dark:ring-white/10 dark:backdrop-blur sm:max-h-[none] sm:rounded-xl lg:h-[34.6875rem] xl:h-[31.625rem]"></div>
            </div> */}
          </div>
        </div>
      </section>
...
const ProjectsIndex = function (projects) {
        ...
        return (
          ...
          >
            ...
            <div
              ...
              class="relative mx-6 flex h-[48.625rem] max-h-[60vh] overflow-hidden bg-slate-800 px-8 shadow-xl dark:bg-slate-900/70 dark:ring-1 dark:ring-inset dark:ring-white/10 dark:backdrop-blur sm:max-h-[none] sm:rounded-xl lg:h-[34.6875rem] xl:h-[31.625rem]"
            >
              <div class="-mx-4 mt-4 sm:mx-0 lg:col-span-7 lg:mt-0 xl:col-span-6">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                  <h2 class="mt-8 font-semibold text-indigo-500 dark:text-indigo-400">
                    {project.category}
                  </h2>
                  <p class="mt-4 text-3xl font-extrabold tracking-tight text-slate-100 dark:text-slate-50 sm:text-4xl ">
                    {project.name}
                  </p>
                  <div class="mt-4 max-w-3xl space-y-6 text-slate-200">
                    ...
                    {/* <p>
                      ...
                      <code class="font-mono font-medium text-slate-900 dark:text-slate-200 ">
                        :focus-visible
                      </code>
                      , and tons more.
                    </p> */}
                  ...
                  >
                    More details
                    <span class="sr-only">, grid template columns</span>
                    <svg
                      class="ml-3 overflow-visible text-indigo-300 group-hover:text-indigo-400 dark:text-white dark:group-hover:text-slate-400"
                      width="3"
                      height="6"
                      viewBox="0 0 3 6"
                      fill="none"
  ...
  {
    /* <div class="mt-10">
          <div class="-mx-4 flex overflow-auto sm:mx-0">
            <ul
              class="grid-template-columns:repeat(3, minmax(6rem, 1fr)) inline-grid flex-none gap-x-2 px-4 sm:px-0 xl:gap-x-6"
              // style="grid-template-columns:repeat(3, minmax(6rem, 1fr))"
            >
              <li>
                <button
                  type="button"
                  class="group flex w-full flex-col items-center text-sm font-semibold text-indigo-600 dark:text-indigo-400"
                >
                  <svg
                    width="48"
                    height="48"
              ...
              <li>
                <button
                  type="button"
                  class="group flex w-full flex-col items-center text-sm font-semibold "
                >
                  <svg
                    width="48"
                    height="48"
