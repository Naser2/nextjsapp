...
export const IpadAudioList = () => {
    return (
        <article class="p-4 sm:p-6 lg:p-4 xl:p-6 space-x-4 items-start sm:space-x-6 lg:space-x-4 xl:space-x-6 flex">
         <img src="/_next/static/media/prognosis-negative.6897ae50.jpg" loading="lazy" decoding="async" alt="" width="60" height="88" class="flex-none rounded-md bg-slate-100"/>
          <div class="min-w-0 relative flex-auto">
            <h2 class="font-semibold text-slate-900 truncate sm:pr-20 dark:text-slate-100">Prognosis Negative</h2>
             <dl class="mt-2 flex flex-wrap text-sm leading-6 font-medium">
              ...
              <dd>2.66</dd>
                ...
                <div class="ml-2"><dt class="sr-only">Year</dt><dd>2021</dd></div>
                <div>
                ...
                <div class="flex-none w-full mt-2 font-normal"><dt class="sr-only">Cast</dt>
