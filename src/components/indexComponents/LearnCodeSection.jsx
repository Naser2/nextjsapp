  ...
  return (
    <>
      ...
      >
          ...
          <div className="" href="/courses">
            ...
            <div className="">
              ...
              >
                ...
                <div className="absolute -top-10 right-0 hidden max-w-2xl lg:block  lg:max-w-none">
                  <h2
                    id="sale-heading"
        ...
        {/* <section
          id="course-on-home-page-favorites"
            ...
            <div className="mt-6 grid grid-cols-1 gap-y-10 sm:grid-cols-3 sm:gap-y-0 sm:gap-x-6 lg:gap-x-8">
              {favorites.map((favorite) => (
                <div key={favorite.id} className="group relative">
                  <div className="h-96 w-full overflow-hidden rounded-lg sm:aspect-w-2 sm:aspect-h-3 group-hover:opacity-75 sm:h-auto">
                    <img
