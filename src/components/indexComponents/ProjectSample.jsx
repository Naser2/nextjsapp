  ...
  return (
    <div id="todolist-text" className="sr-only md:not-sr-only">
      <div id="totolit" className="flex">
        <h1 class="mg:mt-0 col-start-1  row-start-2 mt-6 mb-10 max-w-[36rem] px-4 px-2 text-4xl font-extrabold tracking-tight text-amber-200 sm:text-7xl sm:text-6xl md:mb-0 md:mt-4  xl:max-w-[55.5rem]">
          Reactive Apps
        </h1>
          ...
          <div class="lg:max-w-8xl mx-auto flex flex-col pt-10 md:flex-row md:lg:col-span-5 lg:mx-0 lg:px-8 md:xl:col-span-6 xl:pt-40 ">
            ...
            >
              ...
              <div
                ...
                className="podcast-footer  bg-slate-800  pb-6 md:mx-0 md:pb-2"
              >
