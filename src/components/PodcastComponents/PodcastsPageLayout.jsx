...
import posterImage from '@/images/projectImages/host_poster.png'
  ...
  return (
    <section {...props}>
      ...
      >
        ...
        who have been labeled Poet by a society quick to judge, without actually
...
function PodcastAside({ hosts, classN }) {
  console.log('CLASSS', classN)
  return (
    <header
      className={clsx(
        'lg:w-112 xl:w-120 lg:w-112 relative h-full bg-slate-50 md:pt-10 lg:fixed  lg:left-0  lg:flex lg:items-start lg:overflow-y-auto',
        classN
      )}
    >
      ...
      <div className="relative z-10 mx-auto mt-10 grid pt-4 sm:px-6  md:max-w-xl md:px-4 md:pt-14 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-12 lg:px-8 xl:px-12">
        <div id="main-image" className="px-0 pb-4 sm:px-0">
          <Link
            href="/"
            className="relative mx-auto mx-8 block overflow-hidden  bg-slate-200 shadow-xl shadow-slate-200 sm:rounded-xl lg:w-auto lg:rounded-2xl"
            aria-label="Homepage"
          >
            <Image
              className="w-full"
          ...
          <div className=" pt-4 pb-4 text-center sm:px-6 lg:mt-2 lg:text-left">
            <p className="text-xl font-bold text-slate-900">
              <Link href="/">Talk It Out</Link>
            </p>
            <p className="mt-6 mb-10  px-6  text-lg font-medium leading-8 text-slate-700 md:px-0 lg:mb-14">
        ...
        <AboutSection className="hidden border-t border-slate-500 lg:-mt-32 lg:block lg:py-4 " />
        <div className="relative md:hidden">
          <div
            className="to-blue-500,z-[100] flex h-[40px] w-full flex-col items-center 
        justify-center justify-center bg-gray-100 bg-gradient-to-r bg-gradient-to-r from-black from-sky-500 to-indigo-500 py-2 text-base dark:bg-gray-700 sm:flex-row sm:py-0 md:text-lg lg:flex"
          >
...
export function PodcastsPageLayout({ episodes, children, className }) {
  ...
  return (
    <div className={'lg:mt-14'}>
      ...
      <PodcastAside hosts={hosts} classN={className} />
      {/* </div> */}
      <div
      ...
      <div className="lg:left-112 xl:left-120 fixed relative inset-x-0 bottom-0 z-10 lg:w-3/5 xl:w-2/3">
        <AudioPlayer />
      </div>
    </div>
  )
