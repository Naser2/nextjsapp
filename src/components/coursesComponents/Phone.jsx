  ...
  return (
    <Image
      ...
      className={clsx(
        ...
        'group block  w-2/5 overflow-hidden rounded-lg bg-gray-100 focus-within:ring-offset-2 focus-within:ring-offset-gray-100'
      )}
    />
  )
}
...
// }
// export const Phone = () => {
//     // <div className="flex h-1/4 w-1/3 justify-center -space-x-64 bg-blend-multiply">
//     return (
//     <div className="flex relative h-1/4 w-1/4">
//             <Image src={phone}
//                 alt=""
//             // width={604}
//             // height={700}
