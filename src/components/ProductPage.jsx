      ...
      <div className="bg-white">
        <div className="pt-6">
          ...
          >
            ...
            <div id="first-gid" className="mt-4 lg:row-span-3 lg:mt-0">
                ...
                <div className="mt-10">
                  ...
                  <fieldset className="mt-4">
                    ...
                    <div className="grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4">
                      <label className="group relative flex cursor-not-allowed items-center justify-center rounded-md border bg-gray-50 py-3 px-4 text-sm font-medium uppercase text-gray-200 hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-6">
                      ...
                      <label className="group relative flex cursor-pointer items-center justify-center rounded-md border bg-white py-3 px-4 text-sm font-medium uppercase text-gray-900 shadow-sm hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-6">
