  ...
  return (
    <div
      className={clsx(
        ...
        sticky && 'xl:sticky xl:top-24 [&>:last-child]:mb-0'
      )}
    >
      {children}
    </div>
  ...
  return (
    <li className="m-0 px-0 py-4 first:pt-0 last:pb-0">
      <dl className="m-0 flex flex-wrap items-center gap-x-3 gap-y-2">
        ...
        <dd>
          <code className="code-li-property-name">{name}</code>
        </dd>
        <dt className="sr-only">Type</dt>
        <dd className="code-li-property-value font-mono text-xs dark:text-zinc-500">
          {type}
        </dd>
